...
colname1<-"ControlDependenceEdges"
colname2<-"Nodes"

# read data from Excel
valueCD <- read_excel(paste0(script_dir,"/metrics/Csmith_pass_stat.xlsx"),col_types = "numeric")
valueCE <- read_excel(paste0(script_dir,"/metrics/CsmithEdge_pass_stat.xlsx"),col_types = "numeric")
valueCH <- read_excel(paste0(script_dir,"/metrics/Hicond_pass_stat.xlsx"),col_types = "numeric")
valueY1F <- read_excel(paste0(script_dir,"/metrics/Yarpgen_v1_func_pass_stat.xlsx"),col_types = "numeric")
valueY1D <- read_excel(paste0(script_dir,"/metrics/Yarpgen_v1_driver_pass_stat.xlsx"),col_types = "numeric")
valueY2F <- read_excel(paste0(script_dir,"/metrics/Yarpgen_v2_func_pass_stat.xlsx"),col_types = "numeric")
valueY2D <- read_excel(paste0(script_dir,"/metrics/Yarpgen_v2_driver_pass_stat.xlsx"),col_types = "numeric")
...
ggsave(paste0(script_dir,"/Fig5a.pdf"), width = 16,height = 8)
